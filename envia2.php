...
$secret = RECAPTCHA_SECRET_ENVIA2;
...
if (isset($arr['success']) && $arr['success'] == 1) {
	...
	$mensagem .= "<b>Número:</b> " . texto(isset($_POST['contato']) ? $_POST['contato'] : '') . " <br />";
...
<head>
	...
	<script>
		...
		gtag('event', 'conversion', {'send_to': 'AW-11391837984/X4VCCPz_rvYYEKDOhrgq'});
	</script>
</head>
<body>
</body>
