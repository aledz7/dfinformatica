...
<head>
  ...
  <script>
  (function(){var l=['assets/css/bootstrap.min.css','assets/css/style.css','assets/css/fontawesome-5.14.0.min.css','assets/css/flaticon.min.css'];function a(){l.forEach(function(h){var k=document.createElement('link');k.rel='stylesheet';k.href=h;document.head.appendChild(k);})}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',a)}else{a()}})();
  </script>
  <noscript><link rel="stylesheet" href="assets/css/bootstrap.min.css"><link rel="stylesheet" href="assets/css/style.css"><link rel="stylesheet" href="assets/css/fontawesome-5.14.0.min.css"><link rel="stylesheet" href="assets/css/flaticon.min.css"></noscript>
